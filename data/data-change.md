...
For change old value in dataset value
need use **attr**
...
<body>
	<div class="w3-container">
      <div class="w3-container w3-teal">
        <h1>Работа с DATASET </h1>
      </div>
      <br>
      <div class="w3-container">
           <button class="w3-button w3-purple" onclick="ShowDiv()">Проверка в лог</button>
           <div id="user" 
                data-id="1234567890" 
                data-user="johndoe" 
                ...
                data-foo="Test-4444"
                data-object>Нажми F12 для просомтра работы программы в консоле
           </div>
